"""Fixtures shared across the core Sieve test suite.

experiment-harness fixtures (synthetic_molecule_set) live in
experiments/tests/helpers.py instead, kept there so everything
experiment-related stays contained under experiments/.
"""
