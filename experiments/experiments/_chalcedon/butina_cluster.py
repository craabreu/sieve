...
Vendored from https://github.com/rowansci/chalcedon at commit
...
from experiments._chalcedon.tanimoto_similarity import (
    Precision,
    TanimotoSimilarity,
)
...
def butina_cluster(
    ...
    Args:
        ...
        progress: whether to print tqdm progress bars to stderr. Not part
            of upstream chalcedon; added for library use. Default False.
