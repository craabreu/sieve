...
def test_merge_node_stats_matches_computing_on_the_union_directly():
    ...
    from experiments.tree_artifact import compute_node_stats, merge_node_stats
...
def test_fold_node_stats_of_a_single_shard_is_that_shard():
    from experiments.tree_artifact import compute_node_stats, fold_node_stats
...
def test_fold_node_stats_rejects_an_empty_sequence():
    from experiments.tree_artifact import fold_node_stats
