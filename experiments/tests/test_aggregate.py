...
def test_mlflow_metric_names_normalize_to_the_run_dir_spelling():
    ...
    from experiments.aggregate import normalize_mlflow_metric_name as norm
...
def _rows(triples):
    ...
    from experiments.aggregate import RunRow
...
def test_split_names_map_to_metric_key_prefixes():
    ...
    from experiments.aggregate import SPLIT_PREFIX
...
def test_build_curve_aggregates_repeated_x_to_mean_and_min_max():
    from experiments.aggregate import build_curve
...
def test_build_curve_drops_a_run_missing_the_metric():
    ...
    from experiments.aggregate import RunRow, build_curve
...
def test_aggregate_rows_persists_the_mean_min_max_n_runs_band():
    ...
    from experiments.aggregate import aggregate_rows, build_curve
...
def test_aggregate_rows_pools_every_run_sharing_one_x_value():
    ...
    from experiments.aggregate import RunRow, aggregate_rows, build_curve
